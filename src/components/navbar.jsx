  ...
  useEffect(() => {
    ...
    return (
      ...
      <div id="mobile" className={`${
        ...
        } lg:hidden fixed grid duration-300 ease-out gap-6 text-left z-50 text-black font-primary text-sm h-auto w-full p-3 pb-72 pt-28 bg-white/90 backdrop-blur-md mx-auto max-w-screen-xl `}>
